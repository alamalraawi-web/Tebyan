  ...
  return (
    <>
      ...
      <style>{`
        ...
        html[data-tibyan-theme="dark"] .home-icon-topbar{border-color:rgba(233, 237, 239, 0.14);background:#fff!important;box-shadow:0 14px 36px rgba(0,0,0,.28)!important}html[data-tibyan-theme="dark"] .home-brand-copy strong{color:#dff4ff}html[data-tibyan-theme="dark"] .home-brand-copy small{color:#76b8c2}html[data-tibyan-theme="dark"] .home-settings-button{background:transparent!important;color:#62d8ec!important;box-shadow:none!important}
